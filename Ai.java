...
public class Ai extends JFrame implements MouseListener, MouseMotionListener{
  ...
  a = new int[9][9];
	  ...
	  Board = new JPanel();
  	  ...
  	  for (int i = 0; i < 64; i++) {
  		  ...
  		  int row = (i / 8) % 2;
  		  if (row == 0)
  			  p.setBackground( i % 2 == 0 ? Color.black : Color.pink );
  		  else
  			  p.setBackground( i % 2 == 0 ? Color.pink : Color.black );
  }
			  ...
			  Piece.setVisible(true);
			  	...
			  	int flag = 1;
					  ...
					  if(rook.canMove(parentLocation.y/100, parentLocation.x/100, parent.getY()/100, parent.getX()/100, cell.a)) {
						  ...
						  AIPlayer o = new AIPlayer();
						  
						  if(round == 1) {

							  b = o.nextMove(cell.a, true);
							  round = 0;
						  }else {
							  b = o.nextMove(cell.a, false);
							  round = 1;
						  }
						  ...
						  Component g = Board.getComponent((temp*8) + temp2);
						  
						  Container g2 = (Container)g;
